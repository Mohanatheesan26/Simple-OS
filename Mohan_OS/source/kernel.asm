;*****************start of the kernel code of Mohan_OS***************
[org 0x000]
[bits 16]
...
[SEGMENT .data]
    strWelcomeMsg   db  "Welcome to -Mohan_OS-  Enter 'help' to display commands", 0x00
	strPrompt		db	"Mohan_OS>>", 0x00
	cmdMaxLen		db	255			;maximum length of commands

	strOsName		db	"Mohan_OS", 0x00	;OS details
	...
	strHelpMsg2		db  "Type 'info' to display Hardware Informations of the machine",0x00
...
;********************end of the kernel code of Mohan_OS********************
